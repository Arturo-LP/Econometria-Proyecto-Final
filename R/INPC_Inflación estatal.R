...
fecha_2020 <- as.Date("2020-08-01")
fecha_2022 <- as.Date("2022-08-01")
...
inflacion <- inpc_ancho %>%
  mutate(
    ...
    inflacion_2018_2020 = (inpc_2020_08 / inpc_2018_07) - 1, # inflación acumulada
    inflacion_2018_2022 = (inpc_2022_08 / inpc_2018_07) - 1, # inflación acumulada
    
    # TMAC: Tasa Media Anual Compuesta
    # Fórmula: (Valor final / Valor inicial)^(1/n) - 1
    # donde n es el número de años
    
    # Para el período 2018-2020 (2.08 años)
    tmac_2018_2020 = (inpc_2020_08 / inpc_2018_07)^(1/2.08) - 1,
    
    # Para el período 2018-2022 (4.08 años)
    tmac_2018_2022 = (inpc_2022_08 / inpc_2018_07)^(1/4.08) - 1
  ) %>%
